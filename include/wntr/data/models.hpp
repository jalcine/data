...
namespace Wintermute {
    namespace Data {
        namespace Linguistics {
            ...
            struct RDFSaveModel;
            struct RDFLoadModel;
            struct RDFStorage; // (This is a bit complicated, as Soprano doesn't give the usability I had expected.)
            struct RDFLexical;
#endif
            ...
            public:
                 ...
                 * @fn getLexicalMap
                 */
                Lexidata* const lexicalData() { return &this->Model::m_lxdata; }
            ...
            protected:
                 ...
                 * @param info
                 */
                LocalLoadModel(const string& m_pth, const Lexidata& p_in) : LoadModel(p_in), LocalBackend(m_pth) { this->LocalLoadModel::load(); }
                /**
                 * @brief
                 *
                 * @fn LocalLoadModel
            ...
            public:
                void save(){ this->LocalSaveModel::save (); }

                void load(){ this->LocalLoadModel::load (); }
