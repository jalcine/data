...
namespace Wintermute {
    namespace Data {
        /*
         * Proxy class for interface org.thesii.Wintermute.Data.Nodes
         */
        ...
        public:
            NodeInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

            ~NodeInterface();

        public Q_SLOTS: // METHODS
            inline QDBusPendingReply<bool> exists(const LexicalData& in0){
            ...
            inline QDBusPendingReply<> psuedo(LexicalData in0){
                QList<QVariant> argumentList;
                argumentList << qVariantFromValue(in0);
                return asyncCallWithArgumentList(QLatin1String("psuedo"), argumentList);
            }
            ...
            inline QDBusPendingReply<> read(LexicalData in0){
                QList<QVariant> argumentList;
                argumentList << qVariantFromValue(in0);
                return asyncCallWithArgumentList(QLatin1String("read"), argumentList);
            }

            inline QDBusPendingReply<> write(LexicalData in0){
                QList<QVariant> argumentList;
                argumentList << qVariantFromValue(in0);
        ...
        /*
         * Proxy class for interface org.thesii.Wintermute.Data.Rules
         */
        ...
        public:
            RuleInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
        ...
        /*
         * Proxy class for interface org.thesii.Wintermute.Data.System
         */
