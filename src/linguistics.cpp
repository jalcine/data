    ...
    namespace Data {
        namespace Linguistics {
            ...
            void Configuration::setLocale(string const locale)
            {
                ...
                cout << "(database) [Ling:Config] ## Global locale set to " << locale << endl;
            }
            ...
            void Configuration::setDirectory(string const configDir)
            {
                ...
                cout << "(database) [Ling:Config] ## Root directory set to " << configDir << endl;
            }
        } // namespaces
    }
}
