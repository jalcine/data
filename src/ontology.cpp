...
namespace Wintermute {
    namespace Data {
        namespace Ontology {
            ...
            const Concept* Store::obtainConcept ( const string& storeUUID, const string& conceptUUID ) {
                return NULL;
            }

            Instance* Store::obtainInstance ( const string& storeUUID, const string& instanceUUID ) {
                return NULL;
            }
            ...
            const string& Concept::getUUID() const {
                return this->_uuid;
            }
            ...
            const LinkList* Concept::getLinks() const {
                return _links;
            }
            ...
            const Concept* Link::getParentConcept() const {
                return _parent;
            }

            const Concept* Link::getChildConcept() const {
                return _child;
            }

            const Concept* Link::getRelationship() const {
                return _relation;
            }

            const Link* Link::setParentConcept ( const Concept* newParent ) {
                return new Link ( newParent,_child,_relation );
            }

            const Link* Link::setChildConcept ( const Concept* newChild ) {
                return new Link ( _parent,newChild,_relation );
            }

            const Link* Link::setRelationship ( const Concept* newRelation ) {
                return new Link ( _parent,_child,newRelation );
            }
            ...
            const Instance* Instance::obtain ( const string& uuid ) {
                return NULL;
            }
